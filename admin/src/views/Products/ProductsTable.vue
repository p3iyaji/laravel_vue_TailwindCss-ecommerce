        ...
        <div class="flex justify-between border-b-2 pb-3">
            ...
            <div>
                <input v-model="search" @change="getProducts(null)"
                       class="appearance-none relative block w-60 px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
            ...
            <table class="table-auto w-full">
                ...
                <tr>
                    ...
                    <TableHeaderCell @click="sortProduct" class="border-b-2 p-2 text-left" field="updated_at" :sort-field="sortField" :sort-direction="sortDirection">Last Update</TableHeaderCell>
            ...
            <div v-if="!products.loading" class="flex justify-between items-center mt-5">
                ...
                <a
                    ...
                    aria-current="page"
                    class="relative inline-flex items-center px-4 py-2 border text-sm font-medium whitesapce-nowrap cursor-not-allowed"
                    :class="[
                        link.active
...
import { PencilIcon, DotsVerticalIcon, TrashIcon } from '@heroicons/vue/solid'
